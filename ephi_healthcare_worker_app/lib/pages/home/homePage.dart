                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    CardWidget(
                                        ...
                                        value: snapshot.data.totalPatientCount
                                            .toString(),
                                        change: "+" +
                                            snapshot.data.totalPatientChange
                                                .toString(),
                                        text: "Covid+",
                                        title: "this.title",
                                        press: null),
                                    CardWidget(
                                        ...
                                        value: snapshot.data.recoveredCount
                                            .toString(),
                                        change: "+" +
                                            snapshot.data.recoveredChange
                                                .toString(),
                                        text: "Recovered",
                                        title: "this.title",
                                        press: null),
                                    CardWidget(
                                        ...
                                        value:
                                            snapshot.data.diedCount.toString(),
                                        change: "+" +
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    CardWidget(
                                        ...
                                        value: snapshot.data.confirmedCount
                                            .toString(),
                                        change: "+" +
                                            snapshot.data.confirmedChange
                                                .toString(),
                                        text: "Active Cases",
                                        title: "this.title",
                                        press: null),
