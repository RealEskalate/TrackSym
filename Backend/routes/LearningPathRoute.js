...
router.get("/api/resources/learning-path/name/:name", learningPathController.getLearningPathByName);
...
router.patch("/api/resources/learning-path/:_id", learningPathController.updateLearningPath);
