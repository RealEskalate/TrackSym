...
export let strings = new LocalizedStrings({
  "en-US": {
    ...
    PrivacyPolicyShortText:
      "By creating an account, I agree to the TrackSym Terms of Use and Privacy Policy",
    ...
    AgreeingTermsAndServiceOnSignUp:
      "By creating an account, I agree to the TrackSym Terms of\nUse and Privacy Policy",
    ...
    userReminderToCheck:
      ...
      Loading: "loading...",
      TotalSymptomReports:"PEOPLE WITH SYMPTOMS",
      SymptomReportsYesterday:"TOTAL SYMPTOMS REGISTERED",
      SymptomReportsToCOVIDCases:"Symptom Reports to COVID Cases",
      MostReportedSymptom:"MOST COMMON SYMPTOM",
